...
const ComunicadosInterface = () => {
  ...
  const eventos = [
    {
      id: '001',
      nombre: 'Invitación a la ceremonía por el Día de la Bandera',
    ...
    {
      id: '002',
      nombre: 'Reunión de padres de familia del nivel secundaria',
    ...
    {
      id: '003',
      nombre: 'Actividades programadas por el aniversario de Imperial',
    ...
    {
      id: '004',
      nombre: 'Cronograma de evaluciones bimestrales',
    ...
    {
      id: '005',
      nombre: 'Cronograma de evaluciones Trimestrales',
      ...
      <div className="px-3 py-4 sm:px-4 sm:py-4 md:px-6 md:py-6 lg:px-8 lg:py-8 bg-white min-h-screen font-sans">
        ...
        <div className="mb-4 sm:mb-5 md:mb-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 md:gap-4">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-black">COMUNICADOS</h1>
            <BotonConIcono
              texto="Registrar Comunicado"
              IconTSX={
              ...
              onClick={() => {
                router.push("/comunicados/registrar");
              }}
            />
          </div>
        </div>
        ...
        <div className="mb-4 sm:mb-5 md:mb-6 space-y-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-3 lg:gap-4">
            ...
            <div className="flex-1">
              <label className="text-black font-medium text-sm block mb-2">Título:</label>
              <input
                type="text"
                value={searchTerm}
        ...
        {eventosFiltrados.length > 0 && (
          <div className="mt-4 text-center text-sm text-gray-600">
            Mostrando {indiceInicio + 1} - {Math.min(indiceFin, eventosFiltrados.length)} de {eventosFiltrados.length} comunicados
          </div>
        )}
      </div>
    </div>
...
export default ComunicadosInterface;
