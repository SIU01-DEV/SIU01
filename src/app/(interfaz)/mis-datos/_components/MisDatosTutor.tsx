...
const MisDatosDeTutorDeSecundaria = ({
  ...
  const [misDatosTutorSecundariaSaved, setMisDatosTutorSecundariaSaved] =
    useState<Partial<T_Profesores_Secundaria>>({
      Google_Drive_Foto_ID: googleDriveFotoIdCookieValue || undefined,
    });

  const [
    misDatosTutorSecundariaModificados,
    setMisDatosTutorSecundariaModificados,
  ] = useState<Partial<T_Profesores_Secundaria>>({});
  ...
  useEffect(() => {
    ...
    const fetchMisDatos = async () => {
      ...
      try {
        ...
        const misDatosTutorSecundariaData = (
          responseJson as MisDatosSuccessResponseAPI01
        ).data as MisDatosTutor;

        setMisDatosTutorSecundariaModificados(misDatosTutorSecundariaData);

        setMisDatosTutorSecundariaSaved(misDatosTutorSecundariaData);

        //Actualizando Cache

        await userStorage.saveUserData({
          Apellidos: misDatosTutorSecundariaData.Apellidos,
          Genero: misDatosTutorSecundariaData.Genero,
          Google_Drive_Foto_ID:
            misDatosTutorSecundariaData.Google_Drive_Foto_ID,
          Nombres: misDatosTutorSecundariaData.Nombres,
        });
        ...
        if (
          googleDriveFotoIdCookieValue !==
            misDatosTutorSecundariaData.Google_Drive_Foto_ID ||
          nombresCookieValue !== misDatosTutorSecundariaData.Nombres ||
          apellidosCookieValue !== misDatosTutorSecundariaData.Apellidos ||
          generoCookieValue !== misDatosTutorSecundariaData.Genero
        ) {
          fetch("/api/auth/update-cookies", {
            method: "PUT",
            body: JSON.stringify({
  ...
  const handleSubmitUpdateData = async (e: React.FormEvent) => {
    ...
    try {
      const fetchCancelable = await fetchSiasisAPI({
        ...
        method: "PUT",
        body: JSON.stringify({
          Celular: misDatosTutorSecundariaModificados.Celular,
        } as ActualizarMisDatosTutorRequestBody),
      });
      ...
      setMisDatosTutorSecundariaSaved(misDatosTutorSecundariaModificados);

      //Actualizando Cache
      await userStorage.saveUserData({
        Apellidos: misDatosTutorSecundariaModificados.Apellidos,
        Genero: misDatosTutorSecundariaModificados.Genero as Genero,
        Google_Drive_Foto_ID:
          misDatosTutorSecundariaModificados.Google_Drive_Foto_ID,
        Nombres: misDatosTutorSecundariaModificados.Nombres,
      });
    ...
    <>
      {cambiarFotoModal && (
        <CambiarFotoModal
          ...
          initialSource={
            misDatosTutorSecundariaSaved.Google_Drive_Foto_ID &&
            `https://drive.google.com/thumbnail?id=${misDatosTutorSecundariaSaved.Google_Drive_Foto_ID}`
          }
          eliminateModal={() => {
      ...
      <div className="@container -border-2 border-blue-500 w-full lg:w-[85%] max-w-[75rem] h-full grid grid-cols-7 grid-rows-[min-content_1fr] gap-y-4 md:gap-0 max-md:p-[min(1rem,3vw)] py-1.5">
            ...
            <div className="flex flex-col gap-3 justify-center items-center">
              ...
              <FormSection titulo="Información Personal">
                ...
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  nombreDato="Nombres"
                  onChange={handleChange}
                  savedValue={misDatosTutorSecundariaSaved.Nombres}
                />
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  inputAttributes={{
                    minLength: 2,
                  ...
                  onChange={handleChange}
                  savedValue={misDatosTutorSecundariaSaved.Apellidos}
                />
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  isSomethingLoading={isSomethingLoading}
                  modoEdicion={modoEdicion}
                  ...
                  savedValue={misDatosTutorSecundariaSaved.Genero}
                />
                ...
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  nombreDato="Celular"
                  modificable
                  modificatedValue={misDatosTutorSecundariaModificados.Celular}
                  onChange={handleChange}
                  savedValue={misDatosTutorSecundariaSaved.Celular}
                />
              </FormSection>
              ...
              <FormSection titulo="Informacion del Usuario">
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  savedValue={misDatosTutorSecundariaSaved.Nombre_Usuario}
                />
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  isSomethingLoading={isSomethingLoading}
                  modoEdicion={modoEdicion}
                ...
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  savedValue={misDatosTutorSecundariaSaved.Correo_Electronico}
        ...
        <div className="flex w-full h-full justify-center items-start @lg:row-auto row-start-2 col-span-full @lg:col-span-3 @lg:order-none order-2 p-4">
          <MyUserCard
            ...
            isSomethingLoading={isSomethingLoading}
            Nombres={misDatosTutorSecundariaSaved.Nombres}
            Apellidos={misDatosTutorSecundariaSaved.Apellidos}
            Nombre_Usuario={misDatosTutorSecundariaSaved.Nombre_Usuario}
            Google_Drive_Foto_ID={
              misDatosTutorSecundariaSaved.Google_Drive_Foto_ID || null
            }
          />
        </div>
      </div>
...
export default MisDatosDeTutorDeSecundaria;
