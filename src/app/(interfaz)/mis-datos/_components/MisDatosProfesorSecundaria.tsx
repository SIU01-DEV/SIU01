...
const MisDatosDeProfesorDeSecundaria = ({
  ...
  const [misDatosProfesorSecundariaSaved, setMisDatosProfesorSecundariaSaved] = useState<
    Partial<T_Profesores_Secundaria>
  >({
    Google_Drive_Foto_ID: googleDriveFotoIdCookieValue || undefined,
  });

  const [misDatosProfesorSecundariaModificados, setMisDatosProfesorSecundariaModificados] =
    useState<Partial<T_Profesores_Secundaria>>({});
  ...
  const updateFoto = async (Google_Drive_Foto_ID: string | null) => {
    setMisDatosProfesorSecundariaSaved((prev) => ({
      ...prev,
  ...
  useEffect(() => {
    ...
    const fetchMisDatos = async () => {
      ...
      try {
        ...
        const misDatosProfesorSecundariaData = (
          responseJson as MisDatosSuccessResponseAPI01
        ).data as MisDatosProfesorSecundaria;

        setMisDatosProfesorSecundariaModificados(misDatosProfesorSecundariaData);

        setMisDatosProfesorSecundariaSaved(misDatosProfesorSecundariaData);

        //Actualizando Cache

        await userStorage.saveUserData({
          Apellidos: misDatosProfesorSecundariaData.Apellidos,
          Genero: misDatosProfesorSecundariaData.Genero,
          Google_Drive_Foto_ID: misDatosProfesorSecundariaData.Google_Drive_Foto_ID,
          Nombres: misDatosProfesorSecundariaData.Nombres,
        });
        ...
        if (
          googleDriveFotoIdCookieValue !==
            misDatosProfesorSecundariaData.Google_Drive_Foto_ID ||
          nombresCookieValue !== misDatosProfesorSecundariaData.Nombres ||
          apellidosCookieValue !== misDatosProfesorSecundariaData.Apellidos ||
          generoCookieValue !== misDatosProfesorSecundariaData.Genero
        ) {
          fetch("/api/auth/update-cookies", {
            method: "PUT",
            body: JSON.stringify({
  ...
  const handleSubmitUpdateData = async (e: React.FormEvent) => {
    ...
    try {
      const fetchCancelable = await fetchSiasisAPI({
        ...
        method: "PUT",
        body: JSON.stringify({
          Correo_Electronico: misDatosProfesorSecundariaModificados.Correo_Electronico,
          Celular: misDatosProfesorSecundariaModificados.Celular,
        } as ActualizarMisDatosProfesorSecundariaRequestBody)
      });
      ...
      setMisDatosProfesorSecundariaSaved(misDatosProfesorSecundariaModificados);

      //Actualizando Cache
      await userStorage.saveUserData({
        Apellidos: misDatosProfesorSecundariaModificados.Apellidos,
        Genero: misDatosProfesorSecundariaModificados.Genero as Genero,
        Google_Drive_Foto_ID: misDatosProfesorSecundariaModificados.Google_Drive_Foto_ID,
        Nombres: misDatosProfesorSecundariaModificados.Nombres,
      });
  ...
  const handleChange = (
    ...
    setMisDatosProfesorSecundariaModificados((prev) => ({
      ...prev,
      [name]: value,
    }));
  };
    ...
    <>
      {cambiarFotoModal && (
        <CambiarFotoModal
          ...
          initialSource={
            misDatosProfesorSecundariaSaved.Google_Drive_Foto_ID &&
            `https://drive.google.com/thumbnail?id=${misDatosProfesorSecundariaSaved.Google_Drive_Foto_ID}`
          }
          eliminateModal={() => {
      ...
      <div className="@container -border-2 border-blue-500 w-full lg:w-[85%] max-w-[75rem] h-full grid grid-cols-7 grid-rows-[min-content_1fr] gap-y-4 md:gap-0 max-md:p-[min(1rem,3vw)] py-1.5">
          ...
          {!isSomethingLoading && (
            <BotonConIcono
              ...
              onClick={() => {
                ...
                if (modoEdicion)
                  setMisDatosProfesorSecundariaModificados(misDatosProfesorSecundariaSaved);
          ...
          <form onSubmit={handleSubmitUpdateData}>
            <div className="flex flex-col gap-3 justify-center items-center">
              ...
              <FormSection titulo="Información Personal">
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  inputAttributes={{
                    minLength: 8,
                    maxLength: 8,
                    required: true,
                  ...
                  savedValue={misDatosProfesorSecundariaSaved.DNI_Profesor_Secundaria}
                ...
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  nombreDato="Nombres"
                  onChange={handleChange}
                  savedValue={misDatosProfesorSecundariaSaved.Nombres}
                />
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  inputAttributes={{
                    minLength: 2,
                  ...
                  onChange={handleChange}
                  savedValue={misDatosProfesorSecundariaSaved.Apellidos}
                />
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  isSomethingLoading={isSomethingLoading}
                  modoEdicion={modoEdicion}
                  ...
                  savedValue={misDatosProfesorSecundariaSaved.Genero}
                />
              </FormSection>
              ...
              <FormSection titulo="Contacto">
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  nombreDato="Celular"
                  modificable
                  modificatedValue={misDatosProfesorSecundariaModificados.Celular}
                  onChange={handleChange}
                  savedValue={misDatosProfesorSecundariaSaved.Celular}
                />
                ...
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  savedValue={misDatosProfesorSecundariaSaved.Correo_Electronico}
                  modificatedValue={
                    misDatosProfesorSecundariaModificados.Correo_Electronico
                  }
                  onChange={handleChange}
                  modificable
                />
              ...
              {modoEdicion && (
                <BotonConIcono
                  ...
                  disabled={deepEqualsObjects(
                    misDatosProfesorSecundariaSaved,
                    misDatosProfesorSecundariaModificados
                  )}
              ...
              <FormSection titulo="Informacion del Usuario">
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  ...
                  savedValue={misDatosProfesorSecundariaSaved.Nombre_Usuario}
                />
                <DatoFormularioConEtiqueta<T_Profesores_Secundaria>
                  isSomethingLoading={isSomethingLoading}
                  modoEdicion={modoEdicion}
        ...
        <div className="flex w-full h-full justify-center items-start @lg:row-auto row-start-2 col-span-full @lg:col-span-3 @lg:order-none order-2 p-4">
          <MyUserCard
            ...
            isSomethingLoading={isSomethingLoading}
            Nombres={misDatosProfesorSecundariaSaved.Nombres}
            Apellidos={misDatosProfesorSecundariaSaved.Apellidos}
            Nombre_Usuario={misDatosProfesorSecundariaSaved.Nombre_Usuario}
            Google_Drive_Foto_ID={
              misDatosProfesorSecundariaSaved.Google_Drive_Foto_ID || null
            }
          />
        </div>
      </div>
...
export default MisDatosDeProfesorDeSecundaria;
