 ...
 */
export function extraerTipoDeIdentificador(identificador: string): TiposIdentificadores {
  ...
  console.error(`Tipo de identificador inválido encontrado: ${tipoNumerico} en identificador: ${identificador}`);
