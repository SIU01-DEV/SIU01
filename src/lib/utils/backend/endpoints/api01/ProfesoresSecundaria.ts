...
import { GetProfesoresSecundariaSuccessResponse } from "@/interfaces/shared/apis/api01/profesores-secundaria/types";
import { GetProfesoresSecundariaAPI01QueryParams } from "@/interfaces/shared/apis/api01/profesores-secundaria/types";
import { EndpointSiasis } from "../EndpointSiasis";

function formatearQueryParamsProfesoresSecundaria(
  params: GetProfesoresSecundariaAPI01QueryParams,
): string {
...
export const Endpoint_Get_Profesores_Secundaria_API01 = new EndpointSiasis<
  "/api/profesores-secundaria",
  GetProfesoresSecundariaSuccessResponse,
  GetProfesoresSecundariaAPI01QueryParams
>({
  siasisApi: "API01",
  metodoHttp: "GET",
  ruta: "/api/profesores-secundaria",
  queryParamsFormatter: formatearQueryParamsProfesoresSecundaria,
});
