...
export const HORA_MAXIMA_EXPIRACION_PARA_REGISTROS_EN_REDIS_DIA_SIGUIENTE = 1; // 1 AM
export const MINUTO_MAXIMO_EXPIRACION_PARA_REGISTROS_EN_REDIS_DIA_SIGUIENTE = 15; // 15 MIN
