...
export const HORAS_ANTES_INICIO_ACTIVACION = 2; // 2 horas antes del inicio
export const HORAS_ANTES_SALIDA_CAMBIO_MODO_PARA_PERSONAL = 1; // 1 hora antes de la salida
