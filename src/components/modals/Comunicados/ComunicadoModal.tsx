...
const ComunicadoModal = ({
  ...
  return (
    <ModalContainer
      ...
      className="relative bg-white w-[90vw] max-w-[80vw] sm:max-w-lg md:max-w-[60vw] lg:max-w-[50vw] xl:max-w-[40vw] p-6 sm:p-10 min-h-[45vh] sm:min-h-0 flex flex-col justify-center overflow-hidden rounded-xl"
    >
      {/* Logo */}
      <img
      ...
      <div className="relative z-10 flex flex-col justify-between h-full w-full gap-4 sm:gap-6">
        <div className="text-left px-4 sm:px-6 mx-auto max-w-[95%] sm:max-w-[90%] pt-2 sm:pt-4">
